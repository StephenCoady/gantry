...
describe('#container', function() {
  ...
  describe('#list', function() {
    ...
    it('should list no running containers', (done) => {
      request(app)
        .get('/api/containers/running')
        .expect('Content-Type', /json/)
        .end(function(err, res) {
          expect(res.status).to.be.equal(404);
          assert.equal("No running containers found", res.body.message);
          done();
        });
    });
    ...
    it('should not list specific container', (done) => {
      request(app)
...
describe('#remove', () => {
  ...
  it('should list no containers', (done) => {
    request(app)
      .get('/api/containers/all')
      .expect('Content-Type', /json/)
      .end(function(err, res) {
        expect(res.status).to.be.equal(404);
        assert.equal("No containers found", res.body.message);        done();
      });
  });
})
